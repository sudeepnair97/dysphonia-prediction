# -*- coding: utf-8 -*-
"""
Created on Thu Jan 23 21:18:20 2020
This code is for training and testing the dataset using svm
@author: Sudeep
"""
...
X_train, X_test , y_train , y_test = train_test_split(features , target , test_size = 0.2) # 80% training and 20% test

app_input_dataFrame = pd.DataFrame(app_input)

#print(app_input_dataFrame)
...
app_pred = clf.predict(app_input_dataFrame)
